...
stats:
  - value: "$215M"
    ...
    unit: "24 Competitions or fewer"
  - value: "$1.8M"
    label: "PER EXTRA COMPETITION"
    unit: "added above 24"
...
## Inside the team Cost Cap

These items are generally treated as inside the team cap. Do not read a row as a promise that every related invoice counts.

| Item | In plain English |
| --- | --- |
| Performance R&D and design | Research, development, and design work that directly relates to making the F1 car faster. |
| Performance manufacturing | Manufacturing costs for new aerodynamic and performance parts, and other work that directly affects car performance. |
| Car development, testing, and racing | Defined costs connected with developing, manufacturing, testing, and racing F1 cars. This does not mean every event expense is included. |
| Most performance staff | Staff supporting F1 performance generally count, unless a named exclusion or an allocation rule applies. The three highest-paid eligible people are listed with the exclusions. |
...
| Item | In plain English |
| --- | --- |
| F1 driver pay | Salary, retainer, or other consideration for an F1 driver's driving services is excluded, as are that driver's travel and accommodation costs. |
| Other racing drivers and the academy | Other racing-driver consideration and specified travel are excluded, as are costs directly attributable to managing and operating Academy Program Activities. |
| Three highest-paid eligible personnel | Consideration for the three highest-paid eligible individuals is excluded, with associated employer social security and specified travel and accommodation. Formula 1 says this often includes the team principal and chief technical officer. "Often" is not a rule. |
| Marketing and heritage | Marketing costs, and costs directly attributable to heritage-asset activities, are excluded. |
| Corporate functions | Direct costs of human resources, finance, and legal activities are excluded. Finance costs and corporate income tax are also listed exclusions. |
| Specified competition and test travel | Defined hotel, flight, rail, and road-transport costs for personnel moving between an airport or train station, a hotel, and a Competition or Current Car test site. This is not a rule that all travel is excluded. |
...
- [F1 constructors](/constructors) on the Hub.
- [Bearman's Madrid crash and the Haas repair bill](/bearman-haas-crash-cost-cap-madrid-2026) — a case about one repair against the cap, not a restatement of this map.
- Glossary: [Cost Cap](/glossary/cost-cap) and [Relevant Costs](/glossary/relevant-costs).
