...
// Compact tile: who won the last race + the fastest lap, and a countdown to the next
// one. Deeper detail (movers, retirements, full circuit history) lives on the Hub
