...
// Dispatches on `type` so a new chart form (e.g. a lap-pace heatmap) is one
// more case here and one more component under charts/, never a change to
// the article page template itself. See the `charts` column migration
...
export type ChartSpec = GridToFinishChartSpec;
