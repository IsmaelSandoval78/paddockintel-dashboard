...
const FLAG: Record<string, readonly [string, string, string]> = {
  ...
  'British':        ['#012169', '#FFFFFF', '#C8102E'],
  'Dutch':          ['#AE1C28', '#FFFFFF', '#21468B'],
  'French':         ['#002395', '#FFFFFF', '#ED2939'],
  'Australian':     ['#00008B', '#FFFFFF', '#FF0000'],
  'Spanish':        ['#AA151B', '#F1BF00', '#AA151B'],
  'Finnish':        ['#FFFFFF', '#003580', '#FFFFFF'],
  'Canadian':       ['#FF0000', '#FFFFFF', '#FF0000'],
  'German':         ['#000000', '#DD0000', '#FFCE00'],
  'Mexican':        ['#006847', '#FFFFFF', '#CE1126'],
  'American':       ['#B22234', '#FFFFFF', '#3C3B6E'],
  'Monégasque':     ['#CE1126', '#FFFFFF', '#CE1126'],
  'New Zealander':  ['#00247D', '#FFFFFF', '#CC142B'],
  'Argentine':      ['#74ACDF', '#FFFFFF', '#74ACDF'],
  'Brazilian':      ['#009C3B', '#FEDF00', '#002776'],
  'Thai':           ['#A51931', '#F4F5F8', '#2D2A4A'],
  'Japanese':       ['#FFFFFF', '#BC002D', '#FFFFFF'],
  'Austrian':       ['#EE0000', '#FFFFFF', '#EE0000'],
  'Belgian':        ['#000000', '#FAE042', '#EF3340'],
  'Danish':         ['#C60C30', '#FFFFFF', '#C60C30'],
  'Swedish':        ['#006AA7', '#FECC00', '#006AA7'],
  'Swiss':          ['#FF0000', '#FFFFFF', '#FF0000'],
  'Colombian':      ['#FCD116', '#003087', '#CE1126'],
  'Russian':        ['#FFFFFF', '#0039A6', '#D52B1E'],
  'South African':  ['#007A4D', '#FFB81C', '#001489'],
  'Venezuelan':     ['#CF142B', '#FFFFFF', '#003893'],
  'Polish':         ['#FFFFFF', '#DC143C', '#FFFFFF'],
};
