...
LOCALES = {
    "en": {
        ...
        "body_markdown": """The [Cost Cap](/glossary/cost-cap) does not limit every dollar a team spends or earns. It limits Relevant Costs: the defined costs of operating, developing, manufacturing, testing, and racing the F1 car, after the exclusions and adjustments in the Financial Regulations. [VERIFY: FIA D1.2.1]

A plain-English map of what generally falls inside, and what is named as outside — driver pay, the three highest-paid eligible personnel, specified travel, and the separate Power Unit Manufacturer rules — is in [F1 Cost Cap: what's included and excluded](/f1-cost-cap-what-is-included-and-excluded). The regulation text controls an edge case. [VERIFY: FIA D5.1 / D1.6]""",
    },
    "es": {
        ...
        "body_markdown": """El [límite de costes](/es/glossary/cost-cap) no limita cada dólar que un equipo gasta o ingresa. Limita los costes relevantes: los costes definidos de operar, desarrollar, fabricar, probar y hacer correr el coche de F1, después de las exclusiones y los ajustes del Reglamento Financiero. [VERIFY: FIA D1.2.1]

El mapa en lenguaje claro de lo que en general entra, y de lo que queda nominado fuera — el sueldo del piloto, las tres personas elegibles mejor pagadas, determinados viajes y el reglamento separado de los fabricantes de unidades de potencia — está en [Límite de costes de F1: qué incluye y qué excluye](/es/f1-cost-cap-what-is-included-and-excluded). El texto del reglamento decide un caso límite. [VERIFY: FIA D5.1 / D1.6]""",
    },
    "pt": {
        ...
        "body_markdown": """O [teto de gastos](/pt/glossary/cost-cap) não limita cada dólar que uma equipe gasta ou recebe. Ele limita os custos relevantes: os custos definidos de operar, desenvolver, fabricar, testar e correr com o carro de F1, depois das exclusões e dos ajustes do Regulamento Financeiro. [VERIFY: FIA D1.2.1]

O mapa em linguagem direta do que em geral entra, e do que fica nomeado fora — o salário do piloto, as três pessoas elegíveis mais bem pagas, viagens especificadas e o regulamento separado dos fabricantes de unidades de potência — está em [Teto de gastos da F1: o que entra e o que sai](/pt/f1-cost-cap-what-is-included-and-excluded). O texto do regulamento decide um caso-limite. [VERIFY: FIA D5.1 / D1.6]""",
    },
}
