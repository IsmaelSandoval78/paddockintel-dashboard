...
So a driver can put in a brilliant qualifying lap, end up on pole, and still start from 10th or worse because their team decided this was the right weekend to fit a new part they'd already used up their allowance for. It's one of the more confusing rules for new fans precisely because it has nothing to do with how the driver actually performed that weekend — it's an accounting penalty from a completely separate part of the regulations.""",
                ...
                "es": {
                    ...
                    "body_markdown": """Piénsalo como un presupuesto de repuestos para toda la temporada que recibe cada equipo para el motor — una cantidad fija de motores de combustión interna nuevos, turbos, baterías, etc., para que alcancen todo el año. Pasarse de ese presupuesto no se "paga" en dinero — se paga en posiciones de largada en la próxima carrera.
...
Lo que hace estratégicamente interesantes a las banderas rojas es lo que de repente se les permite hacer a los equipos durante la interrupción: normalmente no puedes reconstruir un alerón delantero dañado o cambiar gomas gratis a mitad de carrera, pero durante una bandera roja, los mecánicos pueden hacer reparaciones y cambios de goma en el garage que un piloto de otra forma tendría que hacer — y pagar en tiempo — en una parada normal. Un piloto que venía sufriendo con gomas viejas justo antes de una bandera roja puede volver a salir con un juego fresco sin ningún costo estratégico, por eso una bandera roja puede revolver completamente una carrera que parecía definida momentos antes.""",
                },
            },
            "technical": {
                "en": {
...
There are no mandatory pit stops in a Sprint, so it's a straight sprint to the finish rather than a strategy battle, and only the top eight finishers score points — a smaller points table than the full Grand Prix, but points that count toward the same championship totals all the same.""",
                ...
                "es": {
                    ...
                    "body_markdown": """Piénsalo como una mini-carrera pegada a un fin de semana normal: en vez de dos prácticas más antes del domingo, un puñado de fechas cada año tienen una segunda carrera de verdad el sábado, con su propia grilla definida por su propia clasificación corta — completamente separada de la clasificación que arma la grilla del domingo.
